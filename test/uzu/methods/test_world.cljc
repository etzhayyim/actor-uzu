...
;; Run: bb --classpath 20-actors ./methods/test_world.cljc
...
(def ont (ue/ontology-map (edn/read-string (slurp "schema/ontology.uzu.edn"))))
(def kurage (first (filter #(= "kurage" (:id %)) (ue/organisms "data/seed.kotoba.edn"))))
